...
global $cur_lan;
?>
<div class="swiper-slide overflow-hidden d-flex flex-column align-items-xxl-<?= $cur_lan == 'en' ? 'end' : 'start'; ?> align-items-center">
    ...
    <div class="d-flex position-absolute p-lg-5 mb-4 p-3 col-12 flex-column justify-content-end h-100 align-items-<?= $cur_lan == 'en' ? 'end' : 'start'; ?>">
        ...
        <?php if ($slide1['slogan']): ?>
            <h3 data-aos="fade-up" data-aos-delay="1100" data-aos-offset="-300" data-aos-duration="500" class="text-white fs-3">
                <?= $slide1['slogan']; ?>
            </h3>
        <? endif; ?>
    </div>
