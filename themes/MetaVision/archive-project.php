...
get_header(); ?>
    <section class="bg-cover" style="background: url('<?= $bgPattern['url'] ?? '' ?>');">
        <div
                class="bg-secondary bg-opacity-75 h-100 d-flex flex-wrap align-items-start justify-content-center justify-content-lg-between">
            ...
            <div class="col-2 d-lg-flex d-none justify-content-center align-items-start vh-100">
                <h1 style="transform: rotate(-90deg) translateX(25%);"
                    class="text-white display-lg position-fixed text-uppercase top-50"><?= get_the_title(); ?></h1>
            </div>
        </div>
    </section>
<?php get_footer(); ?>